...
export const copy = {
  metadata: {
    title: "1000 sveikų receptų – be cukraus ir be glitimo",
    description:
  ...
  hero: {
    ...
    trustChips: [
      ...
      { icon: "🛡️", text: "Šiandien taikoma daugiau nei 75 % nuolaida" },
    ],
  },
    ...
    steps: [
      {
        ...
        desc: "Gausite prieigą prie išsamaus receptų meniu kiekvienai metų dienai – visi jie be cukraus ir bei glitimo. Jums nebereikės nieko planuoti!",
      },
      {
        number: "2",
  ...
  testimonials: {
    ...
    messages: [
      ...
      {
        text: "Noriu padėkoti, nes šie receptai pakeitė mano gyvenimą. Sergu diabetu ir man visada buvo sunku rasti skanių ir sveikų alternatīvų. Dabar mėgaujuosi kiekvienu valgiu be jokios baimės. Nuoširdžiai jums ačiū! 🙏",
        time: "19:49",
      },
      {
  ...
  finalCta: {
    ...
    subUrgency:
      "Nepraleiskite progos įsigyti šią receptų knygą su daugiau nei 75 % nuolaida. Pakeiskite savo sveikatą jau dabar su mūsų išsamiu meniu 365 dienoms.",
    headline: "365 DIENŲ RECEPTAI BE CUKRU IR GLITIMO + PAPILDOMOS DOVANOS",
    bundleList: [
    ...
    discountBadge: "DAUGIAU NEI 75 % NUOLAIDA",
  ...
  faq: {
    ...
    doesntWorkHeadline: "KAS NEVEIKIA: ❌",
    doesntWork: [
    ...
    items: [
      { q: "KAIP GAUSIU RECEPTUS?", a: "Visą turinį gausite nurodytu el. paštu iškart po apmokėjimo." },
      { q: "AR GALIU PRISIJUNGTI PER TELEFONĄ?", a: "Taip, receptus galite pasiekti per telefoną, planšetinį ar kompiuterį." },
      { q: "TURITE DAUGIAU KLAUSIMŲ?", a: "Taip, bet kuriuo metu proceso metu galite tiesiogiai užduoti man visus rūpimus klausimus el. paštu." },
  ...
  footer: {
    brand: "Crearis",
    copyright: "2026 © Visos teisės saugomos. Susipažinkite su mūsų Privatumo politika.",
  },
};